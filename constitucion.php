            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                            <li><a class="dropdown-item" href="">Constitucion Politica
                                    <br>
                                    del Estado</a></li>
            ...
            <div class="container">
                <div class="row">
                    <div class="col text-justify " style="">
                        ...
                        <p>
                            La Constitución Política del Estado plurinacional de Bolivia de 2009 es el decimonoveno
                            texto constitucional en la historia republicana de Bolivia.1​ Entró en vigencia el 7 de
                            febrero de 2009, fecha en que fue publicada en la Gaceta Oficial de Bolivia
                        </p>
                        <div class="container text-center">
                            <a class="font-italic  center" href="doc/Constitucion_2009.pdf" target="_blank">
                                <img src="img/nav/cpe.jpg" class="img-fluid img-rounded" alt="">
                            </a>
                        </div>
                        </p>
