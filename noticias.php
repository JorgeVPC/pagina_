...
$con = new DB_con();
$table = "noticia";
$res=$con->select_notice($table);

if (isset($_POST['eliminar1'])) {
    $id=$_POST['id1'];
    $res=$con->delete_notice($id);
...
<body class="" style="background-repeat: no-repeat;" background="img/fondo1.jpg">
    <div class="container bg-light rounded-lg">
        ...
        <!-- para el encabezado--> 
            <div class="mx-auto center container embed-responsive-item"  style="height: 105px"> <!--background-color: lightskyblue-->
            ...
            <p class="text-center text; text-uppercase font-italic font-weight-bold font-size text-primary h3" style=" font-family: Gungsuh" >Viceministerio de
                <br></p> 
                <p class="text-center text; text-uppercase font-italic font-weight-bold font-size text-primary h3" style=" font-family: Gungsuh">
                    ...
                    <div class="col-sm-8">
                        ...
                        <div class="col-sm-4">
                            <nav class="navbar navbar-light bg-light">
                                ...
                                <img src="img/ubicacion.jpg" width="30" height="30" class="d-inline-block align-top" alt="">
                                Ubicacion
                                </a>
                            </nav>
                            <!--Google map-->
                            <div id="map-container-google-3" class="z-depth-1-half map-container-3">
                                ...
                                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d790.7510452050452!2d-68.12399937083268!3d-16.501257613418876!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x915f218a76210af9%3A0x55705a59ac630547!2sViceministerio%20de%20Lucha%20Contra%20el%20Contrabando!5e1!3m2!1ses-419!2sbo!4v1588119680280!5m2!1ses-419!2sbo" width="600" height="450" frameborder="0" style="border:0;" allowfullscreen=""></iframe>
                            </div>
                            <div class="text-center content" >

                                <a class="navbar-brand" href="https://www.facebook.com/ministeriodedefensa.estadoplurinacionaldebolivia/" target="_blank"  >
                                ...
                                <a class="navbar-brand" href="https://www.youtube.com/channel/UCSi4YowPO7bJTqNExTEaggw" target="_blank" >
                                    <img src="img/youtube.png" width="30" height="30" class="d-inline-block align-top" alt="">
                                </a>
                                <a class="navbar-brand" href="index.html"  >
                                    <img src="img/inicio.png" width="30" height="30" class="d-inline-block align-top" alt="">
                                </a>
                            </div>
                        </div> 
                </div>
                ...
                <div class="row">
                  <div class="col text-justify " style="">
                    ...
                    <p class="font-weight-light">
                        <P class="h4 font-weight-bold text-center .titulo">NOTICIAS</P>
    ...
    while($row=mysqli_fetch_row($res))
      {
            ...
            <tr>
            <td class="h4" st><?php echo $row[1]; ?></td>
            <td rowspan="3"><img src="admin/imagenes/<?php echo $row[4]; ?>" class="rounded img-rounded float-right" width="140em"></td>
            </tr>
           
           
            <tr>
            <td style="font-size:12px"><?php echo $row[5]; ?></td>
            </tr>
            <tr>
