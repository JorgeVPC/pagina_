                ...
                <div class="row">
                    <div class="col text-justify " style="">
                        ...
                        <p class="h4 font-weight-bold text-center .titulo">
                            UNIDAD DE SUPERVISION Y CONTROL
                        </p>
                        ...
                        <p>
                            DIRIGIR, ORGANIZAR, COORDINAR Y PLANIFICAR ACTIVIDADES DE SUPERVISIÓN Y CONTROL, ASIMISMO PROCESAR LA INFORMACIÓN RECIBIDA DE LOS DENUNCIANTES, PARA SU VALORACIÓN POSTERIOR DETERMINACIÓN DE SU UTILIDAD Y OPORTUNIDAD; PARA LA EJECUCIÓN DE OPERATIVOS EN LA LUCHA CONTRA EL CONTRABANDO

                        </p>
                        <p class="h5 .subtitulo">
                            ORGANIGRAMA
                        </p>
                        <img class="img-fluid img-rounded" src="img/nav/orgSupervision.jpg" alt="">
                        </p>
                    </div>
