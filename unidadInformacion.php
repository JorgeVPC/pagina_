                ...
                <ul class="navbar-nav">
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                            ...
                            <li><a class="dropdown-item" href="">Organigrama VLCC</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                            <li><a class="dropdown-item" href="unidadGestion.php">Unidad de
                                    Gestion</a></li>
                            <li><a class="dropdown-item" href="">Unidad de
                ...
                <div class="row">
                    <div class="col text-justify " style="">
                        ...
                        <p class="h4 font-weight-bold text-center .titulo">
                            UNIDAD DE INFORMACIÓN Y <BR> COMUNICACIÓN ESPECIALIZADA
                        </p>
                        <p class="h5 .subtitulo">
                            OBJETIVO
                        </p>
                        
                        <p>
                            PLANIFICAR, COORDINAR, DESARROLLAR, EJECUTAR Y SUPERVISAR LAS DIRECTRICES ADMINISTRATIVAS EN ACCIONES DE LUCHA CONTRA EL CONTRABANDO, FORTALECIENDO MECANISMOS DE DESARROLLO DE INFORMACIÓN, SISTEMAS DE INFORMACIÓN GEOGRÁFICA E IMPLEMENTACIÓN DE SISTEMAS DE COMUNICACIÓN, PARA EL CUMPLIMIENTO DE LOS OBJETIVOS DEL VLCC. BRINDANDO INFORMACIÓN SOBRE REGISTROS ESTADÍSTICOS EN INTERACCIÓN CON LOS ACTORES RELACIONADOS A COMISO DE MERCADERÍA.

                        </p>
                        <p class="h5 .subtitulo">
                            ORGANIGRAMA
                        </p>
                        <img class="img-fluid img-rounded" src="img/nav/orgInformacion.jpg" alt="">
                        </p>
                    </div>
