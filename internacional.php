            ...
            <div class="container">
                <div class="row">
                    <div class="col text-justify " style="">
                        <p
                            class=" h3 font-weight-bold text-center .titulo">
                            HEMEROTECA <br> </p>
                        <table class="table table-responsive-md">
                            <tbody>
                                <tr>
                                    <td class="text-center text; font-italic  font-size text-primary h4" colspan="3">
                                        <a href="hemeroteca.php">  FICHAS HEMEROGRAFICAS</a> </td>
                                </tr>
                                <tr class="text-center">
                                    <Th>
                                        <a href="argentina.php">
                                            <IMG class="img-responsive" SRC="img/nav/carpeta2.png" width="150"> <BR>
                                        </a>
                                        Argentina</Th>
                                    <Th><IMG class="img-responsive" SRC="img/nav/carpeta2.png" width="150"> <BR> Brasil
                                    </Th>
                                    <Th>
                                        <a href="chile.php">
                                            <IMG class="img-responsive" SRC="img/nav/carpeta2.png" width="150"> <BR>
