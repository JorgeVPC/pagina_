                                    ...
                                    <tr>
                                        <td class="text-center text; font-italic  font-size text-primary h5"
                                            colspan="3"><a href="hemeroteca.php">FICHAS HEMEROGRAFICAS</a> <br> <a
                                                href="nacional.php">Nacionales </a> > Santa Cruz </td>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        <td>
                                            <a href="https://eldeber.com.bo/135666_decomisan-camiones-con-contrabando-que-venian-desde-peru"
                                                target="_blank">
                                                <IMG class="tama"
                                                    title="CLICK PARA ABRIR ARCHIVO"
                                                    SRC="hemeroteca/nacionales/7.SANTA CRUZ/h1.jpg">
                                            </a>
                                            <BR>Hemeroteca 1
                                        </td>
                                        <td>
                                            <a href="https://eldeber.com.bo/138590_decomisan-29-vehiculos-con-contrabando-en-zona-fronteriza-de-oruro"
                                                target="_blank">
                                                <IMG class="tama" 
                                                    title="CLICK PARA ABRIR ARCHIVO"
                                                    SRC="hemeroteca/nacionales/7.SANTA CRUZ/h2.jpg">
                                            </a>
                                            <BR>Hemeroteca 2
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <a href="https://eldeber.com.bo/143280_implementaran-puestos-militares-en-la-frontera-con-argentina-y-paraguay"
                                                target="_blank">
                                                <IMG class="tama"
                                                    title="CLICK PARA ABRIR ARCHIVO"
                                                    SRC="hemeroteca/nacionales/7.SANTA CRUZ/h3.jpg">
                                            </a>
                                            <BR>Hemeroteca 3
                                        </td>
                                    </tr>
