                ...
                <div class="row">
                    <div class="col text-justify " style="">
                        ...
                        <p class="h4 font-weight-bold text-center .titulo">
                            UNIDAD DE COORDINACION <br> INTERINSTITUCIONAL
                        </p>
                        ...
                        <p>
                            LA UNIDAD DE COORDINACIÓN INTERINSTITUCIONAL,  DEBERÁ, COORDINAR, ARTICULAR, PROMOVER, IDENTIFICAR, FORTALECER, ESTABLECER  LOS PROCESOS Y MECANISMOS DE COORDINACIÓN INTERINSTITUCIONAL, A TRAVES DE LAS RELACIONES CON INSTITUCIONES NACIONALES E INTERNACIONALES QUE TIENEN UNA PARTICIPACIÓN DIRECTA O INDIRECTA EN LA LUCHA CONTRA EL CONTRABANDO, BUSCANDO ALTERNATIVAS PARA MEJORAR LA CALIDAD DE VIDA DE LAS POBLACIONES FRONTERIZAS.

                        </p>
                        <p class="h5 .subtitulo">
                            ORGANIGRAMA
                        </p>
                        <img class="img-fluid img-rounded" src="img/nav/orgCoordinacion.jpg" alt="">
                        </p>
                    </div>
