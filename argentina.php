                                    ...
                                    <tr>
                                        <td class="text-center text; font-italic  font-size text-primary h5"
                                            colspan="3"><a href="hemeroteca.php">FICHAS HEMEROGRAFICAS</a> <br> <a
                                                href="internacional.php">Internacional </a> > Argentina </td>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        <td>
                                            <a href="https://www.clarin.com/mundo/bolivia-renueva-cupula-militar-reto-combatir-contrabando_0_x8yNrkdmu.html"
                                                target="_blank">
                                                <IMG class="tama"
                                                    title="CLICK PARA ABRIR ARCHIVO"
                                                    SRC="hemeroteca/internacionales/1.ARGENTINA/h1.jpg">
                                            </a>
                                            <BR>Hemeroteca 1
                                        </td>
                                        <td>
                                            <a href="https://www.paginasiete.bo/nacional/2018/3/28/comision-aprueba-ley-contra-el-contrabando-en-una-bochornosa-sesion-174680.html"
                                                target="_blank">
                                                <IMG class="tama" 
                                                    title="CLICK PARA ABRIR ARCHIVO"
                                                    SRC="hemeroteca/internacionales/1.ARGENTINA/h2.jpg">
                                            </a>
                                            <BR>Hemeroteca 2
                                        </td>
                                    </tr>
