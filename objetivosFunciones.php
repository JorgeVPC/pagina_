                ...
                <ul class="navbar-nav">
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                            <li><a class="dropdown-item" href="">Objetivo y Funciones</a>
                            </li>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col text-justify " style="">
                        ...
                        Mediante Decreto Supremo Nº 3540 de 25 de abril del 2018, se crea el Viceministerio de Lucha
                        Contra el Contrabando (VLCC.) dentro la estructura del Ministerio de Defensa, con el fin de
                        implementar políticas y estrategias de lucha contra el contrabando y en cumplimiento a la Ley
                        1053 de fortalecer los mecanismos de coordinación interinstitucional, para que, de manera
                        articulada con la Aduana Nacional de Bolivia, las Fuerzas Armadas, Policía Boliviana y el
                        Ministerio Público se realicen tareas de lucha contra el contrabando.
                        <br>

<hr>
                        <p class="h6">Fortalecer los mecanismos y los medios de lucha contra el contrabando para
                            hacerlos más eficientes y eficaces.
                        </p>
                        <div class="text-center">
                        <img class="rounded img-rounded center-block" src="img/objFunciones/obj2.jpg" alt="">
                    </div>
                        <br>
                        <p class="h6">Frenar la guerra económica y el desangramiento económico que sufre Bolivia por el
                            contrabando.
                        </p>
                        <div class="text-center">
                        <img class="rounded img-rounded" src="img/objFunciones/obj3.jpg" alt="">
                        <img class="rounded img-rounded " src="img/objFunciones/obj4.jpg" alt="">
                    </div>
                        <br>
                        <p class="h6">Reducir al mínimo el ingreso de mercadería ilegal.
                        </p>
                        <div class="text-center">
                        <img class="rounded img-rounded " src="img/objFunciones/obj5.jpg" alt="">
                        <img class="rounded img-rounded " src="img/objFunciones/obj6.jpg" alt="">
                        <img class="rounded img-rounded " src="img/objFunciones/obj7.jpg" alt="">
                    </div>
                    </div>
