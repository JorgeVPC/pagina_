            ...
            <div class="container">
                <div class="row">
                    <div class="col text-justify " style="">
                        ...
                        <p>
                            GESTIONAR LOS RECURSOS ASIGNADOS A LA LUCHA CONTRA EL CONTRABANDO DE ACUERDO A LA NORMATIVA LEGAL VIGENTE EN EL ESTADO PLURINACIONAL DE BOLIVIA, PARA SATISFACER LAS NECESIDAES EN MEDIOS HUMANOS, MATERIALES Y TECNICOS A LAS OPERACIONES QUE REALIZARA EL VLCC, CON EL FIN DE NEUTRALIZAR LAS ACTIVIDADES ILICITAS DE CONTRABANDO.

                        </p>
                        <p class="h5 .subtitulo">
                            ORGANIGRAMA
                        </p>
                        <img class="img-fluid img-rounded" src="img/nav/orgGestion.jpg" alt="">
                        </p>
                    </div>
