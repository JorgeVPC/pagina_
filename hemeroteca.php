                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                ...
                                <li><a class="dropdown-item" href="">Hemeroteca</a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col text-justify " style="">
                        <p
                            class=" h4 font-weight-bold text-center .titulo">
                            HEMEROTECA <br> </p>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-center text; font-italic  font-size text-primary h4" colspan="3">
                                        FICHAS HEMEROGRAFICAS</td>

                                </tr>
                                <tr class="text-center">
                                    <Th>
                                        <a href="nacional.php">
                                            <IMG class="img-responsive" SRC="img/nav/carpeta.png" width="150">
                                        </a>
                                        <BR> NACIONALES
                                    </Th>
