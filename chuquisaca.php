                    ...
                    <ul class="navbar-nav">
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                ...
                                <li><a class="dropdown-item" href="leyes.html">Marco Legal</a></li>
                                    ...
                                    <tr>
                                        <td class="text-center text; font-italic  font-size text-primary h5"
                                            colspan="3"><a href="hemeroteca.php">FICHAS HEMEROGRAFICAS</a> <br> <a
                                                href="nacional.php">Nacionales </a> > Chuquisaca </td>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        <td>
                                            <a href="hemeroteca/nacionales/2.CHUQUISACA/ARCHIVO DIGITAL/Contrabando_ Convoy rompe un cerco militar.html"
                                                target="_blank">
                                                <IMG class="tama"
                                                    title="CLICK PARA ABRIR ARCHIVO"
                                                    SRC="hemeroteca/nacionales/2.CHUQUISACA/h1.jpg">
                                            </a>
                                            <BR>Hemeroteca 1
                                        </td>
                                        <td>
                                            <a href="https://correodelsur.com/economia/20190815_cierran-frontera-con-chile-por-violencia-entre-contrabandistas-y-militares.html"
                                                target="_blank">
                                                <IMG class="tama" 
                                                    title="CLICK PARA ABRIR ARCHIVO"
                                                    SRC="hemeroteca/nacionales/2.CHUQUISACA/h2.jpg">
                                            </a>
                                            <BR>Hemeroteca 2
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <a href="hemeroteca/nacionales/2.CHUQUISACA/ARCHIVO DIGITAL/Pisiga_ Atacan a militares tras golpe al contrabando.html"
                                                target="_blank">
                                                <IMG class="tama" 
                                                    title="CLICK PARA ABRIR ARCHIVO"
                                                    SRC="hemeroteca/nacionales/2.CHUQUISACA/h3.jpg">
                                            </a>
                                            <BR>Hemeroteca 3
                                        </td>
                                        <td> 
                                            <a href="hemeroteca/nacionales/2.CHUQUISACA/ARCHIVO DIGITAL/Militares y contrabandistas se enfrentaron 136 veces.html"
                                                target="_blank">
                                                <IMG class="tama" 
                                                    title="CLICK PARA ABRIR ARCHIVO"
                                                    SRC="hemeroteca/nacionales/2.CHUQUISACA/h4.jpg">
                                            </a>
                                            <BR>Hemeroteca 4</td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <a href="hemeroteca/nacionales/2.CHUQUISACA/ARCHIVO DIGITAL/El Ejército frustra ingreso de convoy de contrabando.html"
                                                target="_blank">
                                                <IMG class="tama" 
                                                    title="CLICK PARA ABRIR ARCHIVO"
                                                    SRC="hemeroteca/nacionales/2.CHUQUISACA/h5.jpg">
                                            </a>
                                            <BR>Hemeroteca 5
                                        </td>
                                        <td> 
                                            <a href="hemeroteca/nacionales/2.CHUQUISACA/ARCHIVO DIGITAL/Contrabandistas emboscan a Aduana y FFAA en Abapó, Santa Cruz.html"
                                                target="_blank">
                                                <IMG class="tama" 
                                                    title="CLICK PARA ABRIR ARCHIVO"
                                                    SRC="hemeroteca/nacionales/2.CHUQUISACA/h6.jpg">
                                            </a>
                                            <BR>Hemeroteca 6</td>
                                    </tr>
                                </tbody>
