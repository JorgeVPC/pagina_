            ...
            <div class="container">
                <div class="row">
                    <div class="col text-justify " style="">
                        ...
                        <p>
                            Para un eficiente desarrollo de las actividades administrativas, logísticas y de apoyo
                            técnico para la Lucha Contra el Contrabando, se realizó el siguiente organigrama:
                        </p>
                        <img class="img-fluid img-rounded" src="img/nav/Organigrama.jpg" alt="">
                        </p>
                    </div>
