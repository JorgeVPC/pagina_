                        ...
                        <table class="table table-responsive-md">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-center text; font-italic  font-size text-primary h5" colspan="3">
                                        <a href="hemeroteca.php">FICHAS HEMEROGRAFICAS</a> <br> <a
                                            href="nacional.php">Nacionales </a> > Beni</td>
                                </tr>
                                <tr class="text-center">
                                    <Th>

                                        <a href="hemeroteca/nacionales/1.BENI/ARCHIVO DIGITAL/Navales secuestran 3.000 pies tablares de madera ilegal - La Palabra del Beni.html"
                                            target="_blank">
                                            <IMG title="CLICK PARA ABRIR ARCHIVO" class="img-responsive"
                                                SRC="hemeroteca/nacionales/1.BENI/b1.jpg">
                                        </a>
                                        <BR>Hemeroteca 1
                                    </Th>
                                </tr>
